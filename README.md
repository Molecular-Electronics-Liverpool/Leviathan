...
The complete development history and changes up to the current release can be found in the `Leviathan/Version log/VersionLog.txt` file included in this repository.
