...
If you use this 'Leviathan' software or any of its constituent subVIs within in your research, please cite this artifact as follows:
...
The complete development history and changes up to the current release can be found in the `Leviathan v4.1.0/Version log/VersionLog.txt` file included in this repository.
